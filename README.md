...
│   ├── SKILL.md               ← v9.6 编排器精简脊柱（主入口；新增 FAILURE 18-21 + Global Rules 20-22 + Phase 3B/4A.5 调度）
...
| FAILURE MODES | 16 | 21（+18 AC ambiguity、+19 cross-layer batch cascade、+20 design over-spec cascade、+21 no data for layer removal） |
| Global Rules | 18 | 22（+20 calibration anchor 必引、+21 sub-artifact 落盘纪律、+22 ablation 安全规则） |
...
| FAILURE MODES | 7 | 10 | 11 | 12 | 13 | 14 | 16 | 21 |
| Global Rules | 8 | 11 | 12 | 13 | 13 | 14 | 18 | 22 |
...
v9.6 记录了 21 个从实际运行中发现的故障模式，每个都有对应的修复措施。关键项：
