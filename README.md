...
| Global Rules | 13 | 18（+15-18 安全/性能/排错/健康） |
...
- **FAILURE 18** (v9.6): AC 含糊到 Phase 4 才暴露 — design_doc 验收准则没有可机验性，DAG 跑完才发现"这个 AC 到底要做啥"。修复：Phase 3B AC 验签（reviewer fast-mode 评每条 AC，planner §2f single corrective replan）。
