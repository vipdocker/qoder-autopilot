...
description: Codebase and web research agent for qoder-autopilot. Analyzes existing code patterns, UI sibling naming conventions, API field naming conventions, and gathers external best practices.
version: 9.7.1
color: cyan
emoji: "\U0001F50E"
